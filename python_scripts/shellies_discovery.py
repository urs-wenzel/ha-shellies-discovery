...
MODEL_SHELLYSHCB1 = f"{ATTR_SHELLY} SHCB-1"
...
MODEL_SHELLYSHCB1_ID = "SHCB-1"  # Shelly SHCB-1
MODEL_SHELLYSHCB1_PREFIX = "shellycolorbulb"
...
TOPIC_LIGHT_ENERGY_SHCB1_COLOR = "~color/{light_id}/energy"
TOPIC_LIGHT_ENERGY_SHCB1_WHITE = "~white/{light_id}/energy"
...
TOPIC_LIGHT_POWER_SHCB1_COLOR = "~color/{light_id}/power"
TOPIC_LIGHT_POWER_SHCB1_WHITE = "~white/{light_id}/power"
...
OPTIONS_SENSOR_LIGHT_ENERGY_SHCB1_COLOR = {
    KEY_DEVICE_CLASS: DEVICE_CLASS_ENERGY,
    KEY_ENABLED_BY_DEFAULT: True,
    KEY_STATE_CLASS: STATE_CLASS_TOTAL_INCREASING,
    KEY_STATE_TOPIC: TOPIC_LIGHT_ENERGY_SHCB1_COLOR,
    KEY_UNIT: UNIT_WH,
    KEY_VALUE_TEMPLATE: TPL_ENERGY_WMIN,
    KEY_SUGGESTED_DISPLAY_PRECISION: 1,
}
OPTIONS_SENSOR_LIGHT_ENERGY_SHCB1_WHITE = {
    KEY_DEVICE_CLASS: DEVICE_CLASS_ENERGY,
    KEY_ENABLED_BY_DEFAULT: True,
    KEY_STATE_CLASS: STATE_CLASS_TOTAL_INCREASING,
    KEY_STATE_TOPIC: TOPIC_LIGHT_ENERGY_SHCB1_WHITE,
    KEY_UNIT: UNIT_WH,
    KEY_VALUE_TEMPLATE: TPL_ENERGY_WMIN,
    KEY_SUGGESTED_DISPLAY_PRECISION: 1,
}
...
OPTIONS_SENSOR_LIGHT_POWER_SHCB1_COLOR = {
    KEY_DEVICE_CLASS: DEVICE_CLASS_POWER,
    KEY_ENABLED_BY_DEFAULT: True,
    KEY_STATE_CLASS: STATE_CLASS_MEASUREMENT,
    KEY_STATE_TOPIC: TOPIC_LIGHT_POWER_SHCB1_COLOR,
    KEY_UNIT: UNIT_WATT,
    KEY_SUGGESTED_DISPLAY_PRECISION: 1,
}
OPTIONS_SENSOR_LIGHT_POWER_SHCB1_WHITE = {
    KEY_DEVICE_CLASS: DEVICE_CLASS_POWER,
    KEY_ENABLED_BY_DEFAULT: True,
    KEY_STATE_CLASS: STATE_CLASS_MEASUREMENT,
    KEY_STATE_TOPIC: TOPIC_LIGHT_POWER_SHCB1_WHITE,
    KEY_UNIT: UNIT_WATT,
    KEY_SUGGESTED_DISPLAY_PRECISION: 1,
}
...
DEVICE_FIRMWARE_MAP = {
    ...
    MODEL_SHELLYSHCB1_ID: MIN_FIRMWARE_DATE,
...
if model_id == MODEL_SHELLYSHCB1_ID or dev_id_prefix == MODEL_SHELLYSHCB1_PREFIX:
    if mode not in (LIGHT_COLOR, LIGHT_WHITE):
        raise ValueError(f"mode value {mode} is not valid, check script configuration")
    ...
    if mode == LIGHT_COLOR:
        light_binary_sensors = {SENSOR_OVERPOWER: OPTIONS_SENSOR_COLOR_LIGHT_OVERPOWER}
        light_sensors = {
            SENSOR_POWER: OPTIONS_SENSOR_LIGHT_POWER_SHCB1_COLOR,
            SENSOR_ENERGY: OPTIONS_SENSOR_LIGHT_ENERGY_SHCB1_COLOR,
        }
    else:
        light_binary_sensors = {SENSOR_OVERPOWER: OPTIONS_SENSOR_WHITE_LIGHT_OVERPOWER}
        light_sensors = {
            SENSOR_POWER: OPTIONS_SENSOR_LIGHT_POWER_SHCB1_WHITE,
            SENSOR_ENERGY: OPTIONS_SENSOR_LIGHT_ENERGY_SHCB1_WHITE,
        }
    sensors = {
        SENSOR_IP: OPTIONS_SENSOR_IP,
        SENSOR_RSSI: OPTIONS_SENSOR_RSSI,
